...
footer: "[https://dicook.github.io/tutorial_effective_data_plots/](https://dicook.github.io/tutorial_effective_data_plots/)"
---
...
- **Hypotheses**: $H_0: p = 0.5$ vs. $H_a: p > 0.5$. <br> Alternative $H_a$ is saying we believe that the coin is biased to heads. <br> Alternative needs to be decided before seeing data. 
